...
export const ShowUpdates = () => {
    return(
        Articles.map(a => <Article header={a.header} date={a.date} paragraph={a.paragraph} link={a.link} likes={0} dislikes={0} handleLike={(event: MouseEvent, recipeId: number) => {}} handleDislike={(event: MouseEvent, recipeId: number) => {}}></Article>)
    );
}